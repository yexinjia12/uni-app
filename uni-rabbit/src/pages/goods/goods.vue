  ...
  localdata.value = {
    ...
    sku_list: res.result.skus.map((v) => {
      return {
        ...
        price: v.price * 100,
        stock: v.inventory,
        sku_name_arr: v.specs.map((i) => i.valueName),
      }
    }),
  }
}
...
// 滑动轮播图
const currSwiperItemIndex = ref(0)
const onChange: UniHelper.SwiperOnChange = (ev) => {
  currSwiperItemIndex.value = ev.detail.current
}
// 点击轮播图-大图预览
    ...
    <view class="goods">
      ...
      <view class="preview">
        ...
        <view class="indicator">
          <text class="current">{{ currSwiperItemIndex + 1 }}</text>
      ...
      <view class="action">
        <view @tap="openSkuPopup(SkuMode.Both)" class="item arrow">
          ...
          <text class="text ellipsis"> {{ selectShop }} </text>
        </view>
