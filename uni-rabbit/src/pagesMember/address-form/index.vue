...
// 是否为默认地址
const onDefaultChange: UniHelper.SwitchOnChange = (ev) => {
...
const rules: UniHelper.UniFormsRules = {
  ...
  contact: {
    rules: [
      ...
      { pattern: /^1[3-9]\d{9}$/, errorMessage: '请填写正确的手机号' },
    ],
  },
  fullLocation: {
...
const onSubmit = async () => {
  try {
    ...
    uni.showToast({ icon: 'error', title: '请填写完整的地址信息' })
  }
}
</script>
  ...
  <view class="content">
    <uni-forms ref="formRef" :rules="rules" :model="form">
      ...
      <view class="form-item">
        ...
        <switch @change="onDefaultChange" class="switch" color="#27ba9b" :checked="form.isDefault === 1" />
      </view>
    </uni-forms>
  </view>
  <!-- 提交按钮 -->
